...
yes.addEventListener("click", () => {
  ...
  gif.src = "../resources/idc.gif";// gif credit: c:\Users\Dell\Downloads\gif_0_1769264728.gif
  text.innerHTML = "Knew it babe 😘";
  yes.innerHTML = '<a href="https://www.instagram.com/davaad7rj_?igsh=MTJ1dzlzc3lhY21oMg%3D%3D&utm_source=qr">Message me</a>';// inside the " " put your social media profile link
  yes.style.height = "90%";
  yes.style.width = "96%";
  no.style.display = "none";
  setTimeout(() => {
